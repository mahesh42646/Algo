...
export default function UserProfile() {
  ...
  const walletBalances = useMemo(
    () => (Array.isArray(wallet?.balances) ? wallet.balances : []),
    [wallet],
  );
  ...
  const activeApiKeys = useMemo(
    () =>
      Array.isArray(user?.integrations)
        ? user.integrations.filter((k) => k?.isActive !== false).length
        : 0,
    [user],
  );
  ...
  const onCreateNotification = async (e) => {
    ...
    try {
      ...
      if (!resp?.success)
        throw new Error(resp?.error || "Failed to create notification");
      ...
      <div className="mt-4 mb-4">
        ...
        >
          <div className="card-body p-2 p-md-3">
            <nav>
              <div
                className="nav nav-tabs border-0 d-flex flex-wrap justify-content-center"
                id="profileTabs"
                role="tablist"
                style={{ gap: "0.25rem" }}
              >
                  ...
                  style={{
                    ...
                    background:
                      activeTab === "overview"
                        ...
                        : "transparent",
                    color:
                      activeTab === "overview" ? "white" : "var(--text-muted)",
                    boxShadow:
                      activeTab === "overview"
                  ...
                  style={{
                    ...
                    background:
                      activeTab === "reference"
                        ...
                        : "transparent",
                    color:
                      activeTab === "reference" ? "white" : "var(--text-muted)",
                    boxShadow:
                      activeTab === "reference"
                  ...
                  style={{
                    ...
                    background:
                      activeTab === "wallet"
                        ...
                        : "transparent",
                    color:
                      activeTab === "wallet" ? "white" : "var(--text-muted)",
                    boxShadow:
                      activeTab === "wallet"
                  ...
                  <div className="text-center position-relative">
                    <div
                      style={{
                        ...
                        margin: "0 auto 15px",
                        border:
                          "clamp(3px, 1vw, 5px) solid rgba(255, 255, 255, 0.3)",
                    ...
                    <p
                      className="mb-0 opacity-90 text-truncate"
                ...
                <div className="card-body p-3 p-md-4">
                  ...
                  <div className="mb-3">
                    <div className="d-flex align-items-center justify-content-between mb-3">
                      <div className="d-flex align-items-center">
                        ...
                        >
                          <svg
                            ...
                            width="16"
                            height="16"
                            fill={user.verified ? "#28a745" : "#ffc107"}
                            viewBox="0 0 16 16"
                          >
                      ...
                      <span
                        className={`badge ${user.verified ? "bg-success" : "bg-warning"}`}
                    ...
                    <div className="d-flex align-items-center justify-content-between">
                      <div className="d-flex align-items-center">
                        ...
                        >
                          <svg
                            ...
                            width="16"
                            height="16"
                            fill={user.twoFactorEnabled ? "#28a745" : "#6c757d"}
                            viewBox="0 0 16 16"
                          >
                      ...
                      <span
                        className={`badge ${user.twoFactorEnabled ? "bg-success" : "bg-secondary"}`}
                        style={{ fontSize: "clamp(0.7rem, 2vw, 0.85rem)" }}
                      >
            ...
            <div className="col-12 col-lg-8">
              <div className="row g-3 g-md-4">
                <div className="col-12">
                  ...
                  >
                    <div
                      className="card-header border-bottom px-3 px-md-4 py-2 py-md-3"
                      style={{
                        ...
                        <div className="col-12 col-md-6">
                          ...
                          >
                            ...
                            <div className="flex-grow-1">
                              <label className="text-muted small mb-1 d-block fw-semibold">
                                API Keys
                              </label>
                              <p
                                className="mb-0 fw-bold"
                  ...
                  <div
                    ...
                    onMouseEnter={(e) => {
                      if (window.innerWidth > 768) {
                        e.currentTarget.style.transform = "translateY(-4px)";
                        e.currentTarget.style.boxShadow =
                          "0 8px 25px rgba(67, 233, 123, 0.15)";
                      }
                    }}
                    onMouseLeave={(e) => {
                      e.currentTarget.style.transform = "translateY(0)";
                      e.currentTarget.style.boxShadow =
                        "0 4px 20px rgba(67, 233, 123, 0.1)";
                    }}
                  >
                    <div
                      className="card-header border-bottom px-3 px-md-4 py-2 py-md-3"
                ...
                <div className="card-body p-3 p-md-4">
                  <div className="text-center py-5">
                    ...
                    <p className="text-muted mb-4">
                      View and manage user's referral connections and rewards
                    </p>
                  </div>
                  ...
                  <div className="row g-3 mb-4">
                    <div className="col-12 col-md-4">
                      ...
                      >
                        ...
                        <h4 className="mb-0 fw-bold text-purple">
                  ...
                  <div className="mb-4">
                    ...
                    >
                      ...
                      <div className="d-flex align-items-center">
                        <code
                          className="flex-grow-1 me-2 p-2 bg-light rounded font-monospace"
                    ...
                    <table className="table table-hover mb-0">
                      <thead>
                        <tr style={{ background: "rgba(168, 85, 247, 0.05)" }}>
                          <th
                            className="px-3 py-3 fw-semibold text-muted"
                            style={{
              ...
              <div className="mb-4">
                ...
                >
                  <div className="card-body p-0">
                    <nav>
                      <div
                        className="nav nav-pills d-flex flex-wrap justify-content-center gap-2"
                        id="notificationTabs"
                        role="tablist"
                      >
                        <button
                                ...
                                >
                                  ...
                                  >
                                    {notification.icon === "shield" && (
                                      <path d="M5.338 1.59a61.44 61.44 0 0 0 4.654.29c.21-.007.374-.26.344-.44-.054-.427-.836-.986-2.431-1.05C6.5.228 5.617.466 5.338 1.59zM7 4.674c1.787.553 5.363 1.725 5.363 4.042 0 1.847-1.39 3.366-3.25 3.95a.5.5 0 0 1-.248 0C6.39 12.082 5 10.563 5 8.716c0-2.317 3.573-3.49 5.363-4.042z" />
                                    )}
                                    ...
                                    {notification.icon === "gift" && (
                                      <path d="M3 2.5a2.5 2.5 0 0 1 5 0 2.5 2.5 0 0 1 5 0v.006c0 .07 0 .27-.038.494H15a1 1 0 0 1 1 1v2a1 1 0 0 1-1 1v7.5a1.5 1.5 0 0 1-1.5 1.5h-11A1.5 1.5 0 0 1 1 14.5V6a1 1 0 0 1 1-1V4a1 1 0 0 1 1-1v-.506A2.5 2.5 0 0 1 3 2.5zM2.5 4v1h1V4H2.5zm3 0v1h1V4H5.5zm3 0v1h1V4H8.5z" />
                                    )}
              ...
              >
                ...
                <div className="card-body p-3 p-md-4">
                  ...
                  <div className="text-center py-5">
                    ...
                    <p className="text-muted mb-4">
                      View and analyze user's trading history and performance
                    </p>
                  </div>
                          ...
                          tradeActivities.map((trade, index) => (
                            ...
                            >
                              ...
                              <td className="px-3 py-3">
                                ...
                                >
                                  {trade.metadata?.side
                                    ? String(trade.metadata.side).toUpperCase()
                                    : "TRADE"}
                                </span>
                              </td>
                              <td className="px-3 py-3">
                  ...
                  <div className="text-center py-5">
                    <div
                      ...
                      style={{
                        ...
                        borderRadius: "50%",
                        background:
                          "linear-gradient(135deg, rgba(139, 69, 19, 0.1) 0%, rgba(101, 67, 33, 0.1) 100%)",
                      }}
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                    ...
                    <p className="text-muted mb-4">
                      Manage and monitor user's automated trading bots
                    </p>
                  </div>
                          ...
                          >
                            <div className="d-flex align-items-start justify-content-between mb-3">
                              <div>
                                ...
                                <small className="text-muted">
                                  {bot.strategyId?.name || "Trading strategy"}
                                </small>
                              </div>
                              <span
                                className={`badge ${
