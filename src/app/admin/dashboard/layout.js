                ...
                <>
                  <div className="d-flex align-items-center flex-grow-1">
                    ...
                    <div className="flex-grow-1 min-w-0">
                      ...
                      <small
                        className="text-white opacity-90 d-block text-truncate"
              ...
              {navItems.map((item) => {
                ...
                return (
                  <Link
                    ...
                    style={{
                      padding:
                        "clamp(0.75rem, 2vw, 0.875rem) clamp(0.875rem, 2vw, 1rem)",
        ...
        >
          <header
            ...
            style={{
              ...
              height: "70px",
              background:
                "linear-gradient(135deg, rgba(255, 255, 255, 1) 0%, rgba(255, 248, 240, 1) 100%)",
            }}
          >
            <div className="d-flex align-items-center justify-content-between h-100 px-3 px-md-4 px-lg-5">
              <div className="d-flex align-items-center">
                ...
                <div>
                  ...
                  <small
                    className="text-muted d-none d-md-block text-truncate"
              ...
              <div className="d-flex align-items-center gap-2 gap-md-3">
                <div className="text-muted d-none d-lg-block text-end">
                  ...
                  <small style={{ fontSize: "clamp(0.7rem, 1.5vw, 0.75rem)" }}>
                    Admin User
                  </small>
                </div>
                <div
